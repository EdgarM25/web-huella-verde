...
function fin_juego() {
    let $veloz = document.querySelector(".veloz");
    let $tiempo = document.querySelector(".tiempo");
    let $start = document.querySelector(".start");
    let $cantidad_estrellas = document.querySelector(".cantidad-estrellas");
...
document.addEventListener("click", (e) => {
    let $input_hidden = document.querySelector("[readonly]");
    //Primera pregunta
    const $label_1_a = document.querySelector(`[for="pregunta_1_a"]`);
    const $label_1_b = document.querySelector(`[for="pregunta_1_b"]`);
    const $label_1_c = document.querySelector(`[for="pregunta_1_c"]`);
    const all_tags_1 = [$label_1_a, $label_1_b, $label_1_c];
    if (e.target.matches("#pregunta_1_a")) {
    ...
    if (e.target.matches("#pregunta_1_b")) {
    ...
    if (e.target.matches("#pregunta_1_c")) {
    ...
    //Segunda pregunta
    const $pregunta_2_true = document.querySelector(`[for="pregunta_2_true"]`);
    const $pregunta_2_false = document.querySelector(`[for="pregunta_2_false"]`);
    const all_tags_2 = [$pregunta_2_false, $pregunta_2_true];
    if (e.target.matches("#pregunta_2_true")) {
        $input_hidden.value = "pregunta_2_true";
        all_tags_2.forEach((elemento) => {
            elemento.classList.remove("selected");
        });
        $pregunta_2_true.classList.add("selected");
    }
    if (e.target.matches("#pregunta_2_false")) {
    ...
    //Tercera Pregunta
    const $pregunta_3_a = document.querySelector(`[for="pregunta_3_a"]`);
    const $pregunta_3_b = document.querySelector(`[for="pregunta_3_b"]`);
    const $pregunta_3_c = document.querySelector(`[for="pregunta_3_c"]`);
    const all_tags_3 = [$pregunta_3_a, $pregunta_3_b, $pregunta_3_c];
    if (e.target.matches("#pregunta_3_a")) {
    ...
    if (e.target.matches("#pregunta_3_b")) {
    ...
    if (e.target.matches("#pregunta_3_c")) {
    ...
    //Cuarta pregunta
    const $pregunta_4_a = document.querySelector(`[for="pregunta_4_a"]`);
    const $pregunta_4_b = document.querySelector(`[for="pregunta_4_b"]`);
    const $pregunta_4_c = document.querySelector(`[for="pregunta_4_c"]`);
    const all_tags_4 = [$pregunta_4_a, $pregunta_4_b, $pregunta_4_c];
    if (e.target.matches("#pregunta_4_a")) {
    ...
    if (e.target.matches("#pregunta_4_b")) {
    ...
    if (e.target.matches("#pregunta_4_c")) {
    ...
    //Quinta pregunta
    const $pregunta_5_a = document.querySelector(".pregunta_5_a");
    const $pregunta_5_b = document.querySelector(".pregunta_5_b");
    const $pregunta_5_c = document.querySelector(".pregunta_5_c");
    const $pregunta_5_1 = document.querySelector(".pregunta_5_1");
    const $pregunta_5_2 = document.querySelector(".pregunta_5_2");
    const $pregunta_5_3 = document.querySelector(".pregunta_5_3");
    const $_pregunta_5_ll_1 = document.querySelector("._pregunta_5_ll_1");
    const $_pregunta_5_ll_2 = document.querySelector("._pregunta_5_ll_2");
    const $_pregunta_5_ll_3 = document.querySelector("._pregunta_5_ll_3");
    const $_pregunta_5_ll_4 = document.querySelector("._pregunta_5_ll_4");
    const $_pregunta_5_ll_5 = document.querySelector("._pregunta_5_ll_5");
    const $_pregunta_5_ll_6 = document.querySelector("._pregunta_5_ll_6");
    const $_pregunta_5_ll_labels = [$_pregunta_5_ll_1, $_pregunta_5_ll_2, $_pregunta_5_ll_3, $_pregunta_5_ll_4, $_pregunta_5_ll_5, $_pregunta_5_ll_6];
    const $_pregunta_5_labels = [$pregunta_5_a, $pregunta_5_b, $pregunta_5_c, $pregunta_5_1, $pregunta_5_2, $pregunta_5_3];
    if (e.target.matches(".pregunta_5_a")) {
    ...
    if (e.target.matches(".pregunta_5_b")) {
    ...
    if (e.target.matches(".pregunta_5_c")) {
    ...
    if (e.target.matches(".pregunta_5_1")) {
    ...
    if (e.target.matches(".pregunta_5_2")) {
    ...
    if (e.target.matches(".pregunta_5_3")) {
    ...
    //sexta pregunta
    const $pregunta_6_a = document.querySelector(".pregunta_6_a");
    const $pregunta_6_b = document.querySelector(".pregunta_6_b");
    const $pregunta_6_c = document.querySelector(".pregunta_6_c");
    const $pregunta_6_1 = document.querySelector(".pregunta_6_1");
    const $pregunta_6_2 = document.querySelector(".pregunta_6_2");
    const $pregunta_6_3 = document.querySelector(".pregunta_6_3");
    const $_pregunta_6_ll_1 = document.querySelector("._pregunta_6_ll_1");
    const $_pregunta_6_ll_2 = document.querySelector("._pregunta_6_ll_2");
    const $_pregunta_6_ll_3 = document.querySelector("._pregunta_6_ll_3");
    const $_pregunta_6_ll_4 = document.querySelector("._pregunta_6_ll_4");
    const $_pregunta_6_ll_5 = document.querySelector("._pregunta_6_ll_5");
    const $_pregunta_6_ll_6 = document.querySelector("._pregunta_6_ll_6");
    const $_pregunta_6_ll_labels = [$_pregunta_6_ll_1, $_pregunta_6_ll_2, $_pregunta_6_ll_3, $_pregunta_6_ll_4, $_pregunta_6_ll_5, $_pregunta_6_ll_6];
    if (e.target.matches(".pregunta_6_a")) {
    ...
    if (e.target.matches(".pregunta_6_b")) {
    ...
    if (e.target.matches(".pregunta_6_c")) {
    ...
    if (e.target.matches(".pregunta_6_1")) {
    ...
    if (e.target.matches(".pregunta_6_2")) {
    ...
    if (e.target.matches(".pregunta_6_3")) {
    ...
    //Verificacion   
    if (e.target.matches(".verification_button")) {
